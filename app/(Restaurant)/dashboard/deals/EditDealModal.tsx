        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm">
            <div className="bg-white rounded-2xl w-full max-w-lg shadow-2xl flex flex-col max-h-[90vh] overflow-hidden">
                ...
                <div className="flex items-center justify-between p-6 border-b border-zinc-100 bg-zinc-50/50">
                    <div>
                        <h2 className="text-lg font-bold text-zinc-900">Edit Deal Settings</h2>
                ...
                <div className="p-6 overflow-y-auto space-y-6">
                    {/* Live Preview Card */}
                    <div className="p-4 bg-[#013622]/5 border border-[#013622]/20 rounded-xl">
                        <p className="text-xs font-bold text-[#013622] uppercase tracking-wider">Live Deal Title Preview</p>
                        <p className="text-lg font-black text-zinc-900 mt-1.5">{generateTitle()}</p>
                    </div>

                    {/* Deal Type Selection */}
                    <div className="space-y-2">
                        <label className="text-xs font-bold text-zinc-500 uppercase tracking-wider">Deal Type</label>
                            ...
                            {[
                                ...
                                <button
                                    ...
                                    className={`py-3 px-4 rounded-xl text-xs font-bold border transition-all text-center ${
                                        dealType === opt.type
                                            ? "bg-[#013622]/5 border-[#013622]/50 text-[#013622] shadow-lg shadow-[#013622]/5"
                    ...
                    <div className="border-t border-zinc-100 pt-4 space-y-4">
                        {dealType === DealType.TWO_FOR_ONE && (
                            <div className="space-y-3">
                                <label className="block text-xs font-bold text-zinc-500 uppercase tracking-wider">What does the deal apply to?</label>
                                <div className="grid grid-cols-2 gap-2">
                                        ...
                                        <button
                                            ...
                                            className={`py-3 px-4 rounded-xl text-xs font-bold border transition-all ${
                                                twoForOneAppliesTo === cat
                                                    ? "bg-[#013622]/5 border-[#013622]/50 text-[#013622]"
                        ...
                        {dealType === DealType.FREE_ITEM && (
                            <div className="space-y-4">
                                <div className="space-y-3">
                                    <label className="block text-xs font-bold text-zinc-500 uppercase tracking-wider">What does the customer buy?</label>
                                ...
                                <div className="space-y-3">
                                    <label className="block text-xs font-bold text-zinc-500 uppercase tracking-wider">What does the customer get free?</label>
                        ...
                        {dealType === DealType.PERCENT_DISCOUNT && (
                            <div className="space-y-4">
                                <div className="space-y-3">
                                    <label className="block text-xs font-bold text-zinc-500 uppercase tracking-wider">Discount Percentage</label>
                                ...
                                <div className="space-y-3">
                                    <label className="block text-xs font-bold text-zinc-500 uppercase tracking-wider">Applies to:</label>
                                    <div className="grid grid-cols-2 gap-2">
                            ...
                            {percentDiscountAppliesTo === PercentDiscountAppliesTo.CATEGORY && (
                                <div className="space-y-3">
                                    <label className="block text-xs font-bold text-zinc-500 uppercase tracking-wider">Select Category:</label>
                                    <div className="grid grid-cols-3 gap-2">
                    ...
                    {dealType === DealType.FIXED_DISCOUNT && (
                        <div className="space-y-4">
                            <div className="space-y-2">
                                <label className="block text-xs font-bold text-zinc-500 uppercase tracking-wider">Minimum Spending Amount (CHF)</label>
                                <input
                                    type="number"
                                    min="0"
                                    max="100"
                                    ...
                                    className="w-full py-3 px-4 rounded-xl bg-white border border-zinc-200 text-sm font-medium text-zinc-900 focus:outline-none focus:ring-2 focus:ring-[#013622]"
                            ...
                            <div className="space-y-2">
                                <label className="block text-xs font-bold text-zinc-500 uppercase tracking-wider">Fixed Discount Amount (CHF)</label>
                                <input
                                    type="number"
                                    min="10"
                ...
                <div className="border-t border-zinc-100 p-6 space-y-4">
                    {/* Days of Week */}
                    <div className="space-y-2">
                        <label className="text-xs font-bold text-zinc-500 uppercase tracking-wider block">Claimable Days</label>
                        <div className="grid grid-cols-4 gap-2">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        {/* Meal Time */}
                        <div className="space-y-2">
                            <label className="text-xs font-bold text-zinc-500 uppercase tracking-wider block">Meal Time</label>
                            <select
                                value={mealTime}
                                onChange={(e) => setMealTime(e.target.value as MealTimeType)}
                                className="w-full bg-white border border-zinc-200 rounded-xl px-4 py-3 text-sm text-zinc-900 focus:outline-none focus:border-[#013622]/50 transition-all cursor-pointer"
                            >
                        ...
                        {/* Max Claims */}
                        <div className="space-y-2">
                            <label className="text-xs font-bold text-zinc-500 uppercase tracking-wider block">Claims Limit</label>
                            <input
                                type="number"
                                min={1}
                                ...
                                required
                                className="w-full bg-white border border-zinc-200 rounded-xl px-4 py-3 text-sm text-zinc-900 focus:outline-none focus:border-[#013622]/50 transition-all"
                            />
                        </div>
                    </div>
                </div>
            ...
            <div className="p-6 border-t border-zinc-100 bg-zinc-50/50 flex gap-3">
                <button
                    ...
                    disabled={isLoading}
                    className="flex-1 bg-[#013622] text-white font-bold py-3.5 rounded-xl hover:bg-[#012a1a] transition-all flex items-center justify-center gap-2 shadow-lg shadow-[#013622]/10 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                    {isLoading ? (
                ...
                <button
                    ...
                    onClick={onClose}
                    disabled={isLoading}
                    className="px-5 py-3.5 rounded-xl bg-white border border-zinc-200 text-zinc-600 hover:bg-zinc-50 transition-all font-bold text-sm"
                >
                    Cancel
                </button>
            </div>
